...
export const SEED_TRANSPORTADORES: Transportador[] = [
  {
    ...
    origem_uf: 'SP',
    origem_endereco: 'Av. Ana Costa',
    origem_numero: '1200',
    origem_bairro: 'Gonzaga',
    origem_cep: '11060-001',
    origem_lat: -23.9608,
    origem_lng: -46.3336,
    raio_km: 120,
    classificacao: 'ouro',
...
export const SEED_MOTORISTAS: Motorista[] = [
  {
    ...
    foto_url: 'https://i.pravatar.cc/400?u=doca-m1',
    avaliacao: 4.7,
    total_avaliacoes: 32,
    situacao: 'ativo',
  ...
  },
  {
    ...
    foto_url: 'https://i.pravatar.cc/400?u=doca-m2',
    avaliacao: 4.2,
    total_avaliacoes: 11,
    situacao: 'ativo',
    created_at: new Date().toISOString(),
  },
  {
    ...
    cnh: '11223344556',
    categoria_cnh: 'E',
    telefone: '(19) 97777-0002',
    foto_url: 'https://i.pravatar.cc/400?u=doca-m3',
    avaliacao: 4.9,
    total_avaliacoes: 48,
    situacao: 'ativo',
    created_at: new Date().toISOString(),
  },
  {
    ...
    foto_url: 'https://i.pravatar.cc/400?u=doca-m4',
    avaliacao: 4.0,
    total_avaliacoes: 7,
    situacao: 'ativo',
    created_at: new Date().toISOString(),
  },
  {
    ...
    foto_url: 'https://i.pravatar.cc/400?u=doca-m5',
    avaliacao: 4.5,
    total_avaliacoes: 19,
    situacao: 'ativo',
    created_at: new Date().toISOString(),
  },
  {
    ...
    foto_url: 'https://i.pravatar.cc/400?u=doca-m6',
    avaliacao: 4.3,
    total_avaliacoes: 22,
    situacao: 'ativo',
    created_at: new Date().toISOString(),
...
export const SEED_CARGAS: Carga[] = [
  ...
  },
  {
    ...
    status: 'negociando',
    prioridade: 'media',
    modo_publicacao: 'leilao',
    prazo_leilao_minutos: 60,
    prazo_alocacao_minutos: 10,
    publicado_em: new Date().toISOString(),
    expira_em: new Date(Date.now() + 60 * 60_000).toISOString(),
    alocacao_expira_em: null,
    justificativa_motivo: null,
    justificativa_obs: null,
    grupo_ids: ['g1', 'g2', 'g3'],
    grupos_notificados: ['g1', 'g2', 'g3'],
    transportador_vencedor_id: null,
    frete_fechado: null,
    placa: null,
    motorista: null,
